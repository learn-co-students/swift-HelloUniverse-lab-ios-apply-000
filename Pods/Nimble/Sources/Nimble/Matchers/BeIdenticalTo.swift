...
public func beIdenticalTo(_ _ expected: AnyObject?) -> NonNilMatcherFunc<AnyObject> {
...
public func b_ e(_ expected: AnyObject?) -> NonNilMatcherFunc<AnyObject> {
    return beIdenticalTo(expected)
}

#if _runtime(_ObjC)
extension NMBObjCMatcher {
    public class func beIdenticalToMatc_ her(_ expected: NSObject?) -> NMBObjCMatcher {
