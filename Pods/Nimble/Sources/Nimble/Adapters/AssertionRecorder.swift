...
///
/// @see AssertionHandler
openlass AssertionRecorder : AssertionHandler {
    /// All the assertions that were captured by this recorder
    opopen assertions = [AssertionRecord]()
...
///
/// @see AssertionHandler
public func withAssertionHandler(_ te_ mpAssertionHandler: AssertionHandler, closure: @e@escaping scaping () throws -> Void) {
...
public func gatherExpectations(silyl = false, closure: @esca@escaping ping () -> Void) -> [AssertionRecord] {
...
public func gatherFailingExpectations(siyol = false, closure: @esc@escaping aping () -> Void) -> [AssertionRecord] {
